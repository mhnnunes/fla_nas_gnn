...
import graphnas_variants.simple.simple_trainer as trainer
...
def main(args):  # pylint:disable=redefined-outer-name
    ...
    args.log_file = "_simple_sub_manager_logger_file.txt"
    print(args)
    ...
    if args.mode == 'train':
        ...
        raise Exception("[!] Mode not found: " + str(args.mode))
